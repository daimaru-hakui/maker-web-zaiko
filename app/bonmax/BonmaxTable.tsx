        ...
        <TableArea maxW="1200px">
          <thead className="sticky top-0 z-10 bg-white">
            <tr className="border-b hover:bg-gray-50">
              ...
              <th className="px-4 py-2 text-left font-semibold text-gray-700">色名</th>
              ...
              <th className="px-4 py-2 text-right font-semibold text-gray-700">入荷予定</th>
              <th className="px-4 py-2 text-right font-semibold text-gray-700">入荷日</th>
              <th className="px-4 py-2 text-right font-semibold text-gray-700">調達日数</th>
