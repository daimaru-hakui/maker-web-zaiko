        ...
        <TableArea maxW="1300px">
          <thead className="sticky top-0 z-10 bg-white">
            <tr className="border-b hover:bg-gray-50">
              ...
              <th className="px-4 py-2 text-left font-semibold text-gray-700">外部在庫数</th>
              <th className="px-4 py-2 text-left font-semibold text-gray-700">仕掛１日付</th>
              <th className="px-4 py-2 text-left font-semibold text-gray-700">仕掛１数量</th>
              <th className="px-4 py-2 text-left font-semibold text-gray-700">仕掛２日付</th>
              <th className="px-4 py-2 text-left font-semibold text-gray-700">仕掛２数量</th>
              <th className="px-4 py-2 text-left font-semibold text-gray-700">仕掛３日付</th>
              <th className="px-4 py-2 text-left font-semibold text-gray-700">仕掛３数量</th>
